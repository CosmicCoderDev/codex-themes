...
[打开 Codex Muse 双语主题皮肤库](https://cosmiccoderdev.github.io/codex-themes/)
...
`preview/index.html` 是一套可交互的独立皮肤原型，预置八套虚构人物主题和八套真人照片主题：
...
在浏览器中打开 `preview/index.html`，即可查看并切换全部人物主题。

## CLI/TUI 附属主题

项目还包含两套 `.tmTheme`，它们只修改 Codex CLI/TUI 的代码语法颜色，不会修改桌面版界面：
